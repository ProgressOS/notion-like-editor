...
const extensionName = "tagCommand";

const prefixChar = "@";

let popup: any;

export const TagCommand = Extension.create({
  name: extensionName,
    ...
    return [
      Suggestion({
        ...
        allow: ({ state, range }) => {
          ...
          // Versione semplificata per permettere ovunque
          const result = isParagraph && isValidAfterContent;
          return result;
        },
