...
export interface KpiChainOptions {
...
export const KpiChain = Node.create<KpiChainOptions>({
  name: "kpiChain",
  ...
  addAttributes() {
    return {
      ...
      tagType: {
        default: TagAutocompleteVariant.KpiChain,
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      "span",
      mergeAttributes(HTMLAttributes, { "data-type": "kpiChain" }),
      0,
    ];
  },
